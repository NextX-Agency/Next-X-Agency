...
function ContactFormFn({ className = '' }: { className?: string }) {
  ...
  if (submitted) {
    return (
      <div className={cn('bg-card rounded-3xl p-10 text-center shadow-xl border border-border', className)}>
  ...
  return (
    <form
      ...
      className={cn('bg-card rounded-3xl p-6 lg:p-8 shadow-xl border border-border', className)}
    >
