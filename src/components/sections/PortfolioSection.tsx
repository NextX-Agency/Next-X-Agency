              ...
              <div className="relative bg-background-elevated overflow-hidden" style={{ height: '280px' }}>
                ...
                <div className="flex items-center gap-1.5 px-3 py-2.5 bg-[var(--browser-bar)] border-b border-border">
                  ...
                  <div className="ml-2 flex-1 rounded-md bg-[var(--browser-field)] h-5 flex items-center px-2.5 gap-1.5">
                    ...
                    <span className="text-[9px] text-muted-foreground font-mono truncate">{project.href.replace('https://', '').replace('www.', '')}</span>
                  </div>
                </div>
                ...
                {/* Large ghost index */}
                <span
                  className="absolute bottom-1 right-3 text-7xl sm:text-6xl font-black text-foreground/5 leading-none select-none pointer-events-none z-10"
                  style={{ fontFamily: 'var(--font-heading)' }}
                >
                  {project.index}
                </span>
