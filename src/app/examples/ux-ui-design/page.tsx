...
const uxAuditService = findService('ux-audit')!
    ...
    >
      ...
      <section className="bg-violet-700 py-16">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="text-violet-200 mb-6 leading-relaxed">Een UX audit kost {formatPrice(uxAuditService.price)} en levert een rapport met verbeterpunten op volgorde van belang, plus een gesprek om het door te nemen. Het eerste kennismakingsgesprek is gratis.</p>
